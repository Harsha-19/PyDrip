...
REQUIRED_KEYS = {"anomaly_reason", "drift_reason", "criticality_weight"}
...
def test_evidence_api_existence():
    ...
    assert hasattr(evidence, "generate_criticality_weight")
...
def test_schema_conformance():
    """Verify evidence dict has exact 3 required keys and all are non-empty strings."""
    change = {
