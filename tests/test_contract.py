...
def get_fixture_data():
    primary_path = os.path.join(os.path.dirname(__file__), "..", "data", "ai_scoring_data", "contract_examples.json")
    fallback_path = os.path.join(os.path.dirname(__file__), "..", "data", "contract_examples.json")
